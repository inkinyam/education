...
const PersonsInfo = [
  ...
  { id: 10,
    ...
    lecturerPhoto: 'https://nc.genplanmos.ru/index.php/apps/files_sharing/publicpreview/Da2o4Te5FynxAxg?x=1780&y=412&a=true&file=%25D0%25A2%25D0%25B5%25D1%2580%25D0%25B5%25D1%2585%25D0%25BE%25D0%25B2%25D0%25B0.png&scalingup=0',
    job: 'Начальник мастерской регионального развития №1 Института Генплана Москвы'
  },

  { id: 11,
    topic: ' ',
    lecturer: 'Бахирев И.А.',
    lecturerPhoto: 'https://nc.genplanmos.ru/index.php/apps/files_sharing/publicpreview/GZ6Y8DwMmiA8qZC?x=1780&y=412&a=true&file=%25D0%2591%25D0%25B0%25D1%2585%25D0%25B8%25D1%2580%25D0%25B5%25D0%25B2.png&scalingup=0',
    job: 'Первый заместитель директора Института Генплана Москвы'
  },

  { id: 12,
    topic: ' ',
    lecturer: 'Ивашкина И.В.',
    lecturerPhoto: 'https://nc.genplanmos.ru/index.php/apps/files_sharing/publicpreview/fZgcSw7RapF3Mxt?x=1780&y=412&a=true&file=%25D0%2598%25D0%25B2%25D0%25B0%25D1%2588%25D0%25BA%25D0%25B8%25D0%25BD%25D0%25B0.png&scalingup=0',
    job: 'Начальник сектора информационно-аналитического обеспечения территориального планирования Института Генплана Москвы'
  },

  { id: 13,
    topic: ' ',
    lecturer: 'Иванова А.А.',
    lecturerPhoto: 'https://nc.genplanmos.ru/index.php/apps/files_sharing/publicpreview/drJNCwser275xHY?x=1780&y=412&a=true&file=%25D0%2598%25D0%25B2%25D0%25B0%25D0%25BD%25D0%25BE%25D0%25B2%25D0%25B0.png&scalingup=0',
    ...
    lecture: [
      {
        ...
        lecturer: 'Перов М.В.',
        lecturerJob: 'Советник директора Института Генплана Москвы'
      },
      {
        ...
        lecturer: 'Терехова Т. А.',
        lecturerJob: 'Начальник мастерской регионального развития №1 Института Генплана Москвы'        
      }
    ]
  },
  {
    ...
    lecture: [
      {
        ...
        lecturer: 'Сычева В.С.',
        lecturerJob: 'Заместитель начальника мастерской регионального развития №1 Института Генплана Москвы'
      ...
      },
      {
        ...
        lecturer: 'Валяев О.В.',
        lecturerJob: 'Начальник управления правовой базы градостроительства'
      }
    ]
  },
  {
    ...
    lecture: [
      {
        ...
        lecturer: 'Бахирев И.А.',
        lecturerJob: 'Первый заместитель директора Института Генплана Москвы'
      },
      {
    ...
    lecture: [
      {
        ...
        lecturer: 'Ивашкина И.В.',
        lecturerJob: 'Начальник сектора информационно-аналитического обеспечения территориального планирования Института Генплана Москвы'
      },
      {
      ...
      },
      {
        ...
        lecturer: 'Иванова А.А.',
        lecturerJob: 'Заместитель директора Института Генплана Москвы'
      },
      {
...
const vebinarsInfo = [
  { 
    ...
    lecture: [
      {
        thesis: [
          'Слагаемые качества градостроительной документации – целеполагание, обоснование, реализуемость;',
          'Вариантное стратегирование при планировании развития города;',
          'Обеспечение эффективного регулирования градостроительного развития – мастер-план или регламентный генплан?',
          ],
        lecturer: 'Колонтай А.Н.',
        lecturerJob: 'Cоветник директора Института Генплана Москвы'
      }
    ]
  },
  {
    ...
    lecture: [
      {
        ...
        lecturer: 'Данилина Н.В.',
        lecturerJob: 'д.т.н., член-корр. РААСН, Зав. Кафедры, «Градостроительство» НИУ МГСУ'
      }
    ]
  },
  {
    ...
    lecture: [
      {
        ...
        lecturer: 'Крестмейн М.Г.',
        lecturerJob: 'Главный инженер Института Генплана Москвы'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    lecture: [
      {
        thesis: [
          'Информационное сопровождение проекторов развития территорий: особенности работы с прессой;',
          'Инструменты вовлечения жителей в разработку градостроительной документации и возможности соучаствующего проектирования;',
          'Практика применения результатов взаимодействия с жителями для улучшения городской в проектах городского планирования',
          ],
        lecturer: 'Пенкин А.С.',
        lecturerJob: 'Начальник управления маркетинга Института Генплана Москвы'
      }
    ]
  },  
  {
